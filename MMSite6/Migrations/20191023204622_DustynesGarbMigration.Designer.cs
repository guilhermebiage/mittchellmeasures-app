...
{
    [DbContext(typeof(MMSite6Context))]
    [Migration("20191023204622_DustynesGarbMigration")]
    partial class DustynesGarbMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMSite6.Areas.Identity.Data.MMSite6User", b =>
                {
                    ...
                    b.Property<string>("businessPostal");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MMSite6.Areas.Identity.Data.MMSite6User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
