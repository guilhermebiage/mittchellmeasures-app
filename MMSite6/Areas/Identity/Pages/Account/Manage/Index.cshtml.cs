...
namespace MMSite6.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.businessAddress != user.businessAddress)
            {
                user.businessAddress = Input.businessAddress;
            }

            if (Input.businessCity != user.businessCity)
            {
                user.businessCity = Input.businessCity;
            }

            if (Input.businessPostal != user.businessPostal)
            {
                user.businessPostal = Input.businessPostal;
            }
